...
if isCalo:
   ...
   pt_AK4 = 5
   chosen_JEC = "AK4PFPuppi"
   chosen_jet_source = 'ak4PFJetsPuppi'
   chosen_label = ''#'Reclustered'
   chosen_pfcand = 'pfPuppi'
   chosen_jets = "patJets"+ chosen_label
else:
...
process.pfPuppi = process.puppi.clone()
#process.pfPuppi = cms.EDFilter("CandPtrSelector", src = cms.InputTag("puppi"), cut = cms.string(""))
...
if isCalo:
   ...
   process.ak4PFJetsPuppiCustom = ak4PFJetsPuppi.clone(src = "pfPuppi", doAreaFastjet = True, jetPtMin = pt_AK4)
...
#jets_to_be_used = jets_after_btag_tools
